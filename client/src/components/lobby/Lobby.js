...
class Lobby extends Component {
  ...
  generateUserInfo(userList) {
    ...
    if (!userList.length) {
      ...
      if (this.state.userPoints.length < 1) {
        ...
        <div className="col">
          <div id="userNames" className="col center-align">
            <ul style={{ marginTop: "10px", marginBottom: "10px" }}>
              {userList.map((item, index) => <li className="white-text" key={index}>{item}</li>)}
            </ul>
          </div>
          <div id="points" className="col center-align" style={{ marginTop: "10px", marginBottom: "10px" }}>
            {userList.map((user, index) => <p className="white-text" style={{ margin: "0px auto" }} key={index}>{this.state.userPoints[index]}</p>)}
          </div>
          <div id="wins" className="col center-align" style={{ marginTop: "10px", marginBottom: "10px" }}>
            {userList.map((user, index) => <p className="white-text" style={{ margin: "0px auto" }} key={index}>{this.state.userWins[index]}</p>)}
          </div>
          <div id="icons" className="col center-align" style={{ marginTop: "10px", marginBottom: "10px" }}>
            {userList.map((user, index) => <p className="white-text" key={index} style={{ margin: "0px auto" }}><i className="tiny material-icons">{this.state.userReady[index] === 0 ? (<span>check_box</span>) : (<span>check_box_outline_blank</span>)}</i></p>)}
          </div>
        </div>
      )
    }
  ...
  generatePlayerCards = () => {
    ...
    for (let i = 0; i <= 7; i++) {
      let tempnum = Math.floor(Math.random() * whiteCardsBaseGame.length)
      this.state.playerHand.push(whiteCardsBaseGame.splice(tempnum, 1));
    }
  }
  chooseRandomBlackCard = () => {
    ...
    let tempnum = Math.floor(Math.random() * blackCardsBaseGame.length)
    this.state.currentBlackCard.push(blackCardsBaseGame.splice(tempnum, 1));
  }
  render() {
    return (
      <div className="container">
        ...
        <div className="row" style={{ marginBottom: "0px" }}>
          {this.state.gamestarted ? (
            <div className="col">
              {console.log(this.state.currentBlackCard[0][0].expansion)}
              {/* {this.chooseRandomBlackCard()} */}
              <div className="card small black darken-1" style={{ width: "225px", height: "225px" }}>
                <div className="card-content white-text center-align" style={{ padding: "20px 15px 0px 15px" }}>
                  ...
                  <span style={{ fontSize: "17px" }}>{this.state.currentBlackCard[0][0].text}</span>
                </div>
                <div className="card-action" style={{ paddingLeft: "0px", paddingRight: "0px", paddingTop: "0px", paddingBottom: "5px", borderTop: "0px solid #000" }}>
                  {/* {this.expansionHandler(this.state.currentBlackCard.expansion)} */}
                  <button className="btn-flat black-text left disabled">{this.state.currentBlackCard[0][0].pick}</button>
                  <button className="btn-flat black-text right disabled">{this.expansionHandler(this.state.currentBlackCard[0][0].expansion)}</button>
                </div>
              </div>
            </div>
          ) : (
          ...
          {this.state.gamestarted ? (
            <div></div>
              ...
              <div id="gameOptions" className="row">
                <div className="col">
                  <button onClick={this.gameStart} className="waves-effect waves-teal btn-flat black-text center-align white-text" style={{ marginLeft: "5px" }}>Start Game</button>
                  <div>
                    <form>
                      <div>
                        <label>
                      ...
                      <label>
                        <input type="checkbox" disabled="disabled" />
                        <span>Second Expansion</span>
                      </label>
                      <div>
                        <label>
                          <input type="checkbox" disabled="disabled" />
                          <span>Third Expansion</span>
                        </label>
                      </div>
                      <label>
                        <input type="checkbox" disabled="disabled" />
                        <span>Fourth Expansion</span>
                      </label>
                      <div>
                        <label>
                          <input type="checkbox" disabled="disabled" />
                          <span>Fifth Expansion</span>
                        </label>
                      </div>
                      <div>
                        <label>
                          <input type="checkbox" disabled="disabled" />
                          <span>Sixth Expansion</span>
                        </label>
                      </div>
                    </form>
                  </div>
                ...
                <div className="col">
                  <div className="input-field">
                    <input palceholder="10" id="score" type="number" className="validate" defaultValue="10" max="20" min="1" />
                    <label htmlFor="score">Enter Score to Win.</label>
                  </div>
                  <div className="input-field">
                    <input palceholder="10" id="playerCount" type="number" className="validate" defaultValue="10" max="10" min="3" />
                    <label htmlFor="playerCount">Enter Max Players.</label>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="row">
          {this.state.gamestarted ? (
            <div id="cardArea" className="col s12 m12 l12">
              {this.state.playerHand.map((card, index) =>
                <div key={index} className="col" style={{ paddingRight: "5px", paddingLeft: "0px" }}>
                  <div className="card white darken-1 small hoverable" style={{ width: "170px", height: "170px", marginBottom: "0px" }}>
                    <div className="card-content black-text center-align" style={{ padding: "15px 10px 0px 10px" }}>
                      <span key={index}>{card[0].text}</span>
                    </div>
                    <div className="card-action" style={{ paddingLeft: "0px", paddingRight: "0px", paddingTop: "5px", paddingBottom: "5px" }}>
                      ...
                      <button className="btn-flat black-text right disabled" style={{ fontSize: "12px" }}>{this.expansionHandler(card[0].expansion)}</button>
                    </div>
                  </div>
                </div>
              )}
